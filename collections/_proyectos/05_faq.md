...
Additionally, there are some tips when using <span class="chulapa">CORUM</span>, as well as code samples.
...
<!-- CORUM Jekyll Theme - VERSION NUMBER HERE -->
...
<h3 id="chulapa-font">...use <span class="chulapa">CORUM</span> font on my theme?</h3>

You can use <span class="chulapa">CORUM</span> as a font just as you would do for any other font, since it is already installed. On your `_config`:
```
chulapa-skin: 
  vars  :
...
This would enable it for headings, however they would be displayed as <span class="lead font-weight-bold" style="font-family: chulapa,sans-serif">CORUM</span>.
...
Then your headings would display as <span class="chulapa lead">CORUM</span>!

As you would notice, on the docs the font is used on the word <span class="chulapa">CORUM</span>. There is a special `css` class named `chulapa` on this theme that enables that behaviour:
