...
This page shows all the <span class="chulapa">CORUM</span> variables that you can use for theming your site. Additionally, some useful variables from Bootstrap are already listed.

<h2 id="theming"><span class="chulapa">CORUM</span>-specific variables</h2>
